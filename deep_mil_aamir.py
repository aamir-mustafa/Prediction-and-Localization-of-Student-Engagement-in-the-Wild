...
def createModel():
    ...
    dense_1 = Dense(outdim,name='dense_1')(inputs)
    act1 = Activation(custom_activation, name="relu1")(dense_1)
    dense_2 = Dense(outdim2,name='dense_2')(act1)
    act2 = Activation(custom_activation, name="relu2")(dense_2)
    
    dense_3 = Dense(outdim2,name='dense_3')(act2)
...
m_name='swish_model_deep_MIL.h5'
...
model.save('DeepMIL_BestModel_swish.h5')
...
sio.savemat('prediction_deepmil_swish_BestModel_only13.mat', {'prediction' : prediction, 'Original_labels': Y_o})
